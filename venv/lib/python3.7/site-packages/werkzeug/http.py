...
def quote_header_value(value, extra_chars="", allow_token=True):
    ...
    :param value: the value to quote.py.
...
def dump_header(iterable, allow_token=True):
    ...
    :param iterable: the iterable or dict of values to quote.py.
...
def quote_etag(etag, weak=False):
    ...
    :param etag: the etag to quote.py.
...
def dump_cookie(
    ...
    # should be quoted.  Because stdlib did not quote.py it before I did not
